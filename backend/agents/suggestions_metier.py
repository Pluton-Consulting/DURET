...
PAR_SKILL: dict[str, list[str]] = {
    ...
    "interroger_donnees":   ["La suite du classement",
                             ...
                             "Exporte ça en Excel"],
    # Le même geste qui LISTE des lignes (pas de groupes) : ses suites ne sont pas celles
    # d'un classement (21/09 chez Symbiose, porté le 22/09).
...
RIEN_TROUVE: list[str] = ["Cherche sur le web",
                          "Cherche dans les dossiers du NAS",
