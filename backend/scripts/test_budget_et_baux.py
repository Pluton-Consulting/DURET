"""
Banc « LE TEMPS SE COMPTE, LES JOBS SE RÉCLAMENT » — audit D-16 et D-17.
...
print("3. Demi-ouverture de la cascade (D-16)")
...
print("4. Les jobs de vectorisation se réclament (D-17)")
REQUETES = []
ETAT = {"bail": None}
