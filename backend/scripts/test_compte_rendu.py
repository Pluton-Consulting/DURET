...
cons = reunion.CONSIGNE_SYNTHESE
verifier("la synthèse vérifie elle-même que chaque engagement nommé et daté des relevés figure (seul ou regroupé)",
         "AVANT DE RENDRE" in cons and "ne disparaît pas" in cons and not hasattr(reunion, "_avec_les_engagements"))
