...
# 15/09 : le lien magique est coupé, le bouton Admin ouvre les cartes à code
# (voir test_connexion_admin.py).
verifier("le petit bouton Admin ouvre les cartes administrateur", 'data-testid="bouton-admin"' in page and 'setVue("admin")' in page)
verifier("retour aux profils depuis la vue Admin", "Retour aux profils" in page)
...
verifier("sans carte : l'écran dit ce qui manque, le bouton Admin reste",
         'data-testid="cartes-vides"' in page and "boite_absente" in page and 'data-testid="bouton-admin"' in page)
