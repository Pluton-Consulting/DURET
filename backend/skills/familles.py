...
FAMILLES: dict[str, tuple[str, ...]] = {
    ...
    "facturation": ("suivre_facture", "factures_suivies", "relancer_factures", "enregistrer_relance",
                    "facture_reglee"),
    "web": ("chercher_web", "ouvrir_page", "naviguer", "fiche_produit"),
    # 23/09 : le droit officiel (Légifrance, Judilibre, par le portail PISTE).
    "droit": ("texte_de_loi", "jurisprudence"),
...
DESCRIPTIONS: dict[str, str] = {
    ...
    "web": "information publique sur internet, ouvrir un site, fiche technique d'un produit ou d'un fabricant",
    "droit": "texte de loi, article de code, convention collective, jurisprudence, marchés publics",
